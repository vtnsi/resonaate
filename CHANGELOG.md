...
- Regression test of the number of obs generated by the `main_init` on the first timestep
...
- Properly use sensor agent types `GROUND_FACILITY_LABEL` and `SPACECRAFT_LABEL`
