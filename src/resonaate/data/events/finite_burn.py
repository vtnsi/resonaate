...
class ScheduledFiniteBurnEvent(Event):
    ...
    MUTABLE_COLUMN_NAMES = Event.MUTABLE_COLUMN_NAMES + (
        "acc_vec_0", "acc_vec_1", "acc_vec_2", "thrust_frame"
    )
    ...
    def handleEvent(self, scope_instance):
        ...
        acc_vector = asarray([self.acc_vec_0, self.acc_vec_1, self.acc_vec_2])
        finite_burn = None
        ...
        finite_burn = ScheduledFiniteBurn(time_vector, thrust_func)
