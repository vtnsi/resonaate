...
class ContinuousStateChangeEvent(metaclass=ABCMeta):
    """Event that describes a continuous change in state that must interrupt integration to be applied.
    ...
    def getStateChangeCallback(self, time):
        """Return the function that calculates your state change continuously.
