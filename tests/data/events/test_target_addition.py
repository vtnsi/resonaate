...
class TestTargetAdditionEventConfig(BaseTestCase):
    ...
    def testDataDependency(self):
        ...
        assert len(addition_dependencies) == 2

        epoch_dependency = addition_dependencies[0]
        assert epoch_dependency.data_type == Epoch
        assert epoch_dependency.attributes is None

        agent_dependency = addition_dependencies[1]
...
class TestTargetAdditionEvent(BaseTestCase):
    ...
    def testFromConfig(self):
        ...
        assert addition_event.station_keeping == addition_config.station_keeping
