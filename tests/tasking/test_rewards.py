...
class TestRewardBase:
    ...
    def testRegistry(self, mocked_reward_class: Reward, mocked_metric: Metric):
    ...
    def testCalculateReward(
        self,
        mocked_reward_class: Reward,
        mocked_metric: Metric,
...
class TestCostConstrainedReward:
    ...
    def getMetricList(self, mocked_metric_class: Metric):
